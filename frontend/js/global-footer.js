(() => {
  ...
  style.textContent = `
    ...
    .nx-footer-logo span{color:#7c3aed}
    .nx-footer-brand p{
      margin:13px 0 0;
      line-height:1.7;
      font-size:14px;
    ...
    @media(prefers-reduced-motion:reduce){
      .nx-footer-column a{transition:none}
    }
  `;
    ...
    footer.innerHTML = `
      <div class="nx-footer-inner">
        <div class="nx-footer-brand">
          ...
          <p>
            Ferramentas digitais simples, rápidas e úteis
            para transformar tarefas em experiências melhores.
          </p>
        </div>
